...
const he: Translations = {
  ...
  'boards.editor.config.uploadImage': 'העלה תמונה',
  'boards.editor.config.chooseFile': 'בחר קובץ',
  'boards.editor.config.uploading': 'מעלה...',
  'boards.editor.config.imageUploaded': 'התמונה הועלתה בהצלחה',
  'boards.editor.config.orUseUrl': 'או',
  'boards.editor.config.invalidFileType': 'אנא בחר קובץ תמונה תקין',
  'boards.editor.config.fileTooLarge': 'גודל הקובץ חייב להיות פחות מ-5MB',
  'boards.editor.config.uploadError': 'העלאת התמונה נכשלה',
