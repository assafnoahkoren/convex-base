const en = {
  ...
  'boards.editor.config.uploadImage': 'Upload Image',
  'boards.editor.config.chooseFile': 'Choose File',
  'boards.editor.config.uploading': 'Uploading...',
  'boards.editor.config.imageUploaded': 'Image uploaded successfully',
  'boards.editor.config.orUseUrl': 'or',
  'boards.editor.config.invalidFileType': 'Please select a valid image file',
  'boards.editor.config.fileTooLarge': 'File size must be less than 5MB',
  'boards.editor.config.uploadError': 'Failed to upload image',
